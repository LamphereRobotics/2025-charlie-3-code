...
public class UpperAlgaeIntake extends SubsystemBase {
  private final SparkMax motor = new SparkMax(UpperAlgaeConstants.IntakeMotor.kCanId,
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("UpperAlgae/Intake/voltage", motor.getAppliedOutput() * motor.getBusVoltage());
  }
