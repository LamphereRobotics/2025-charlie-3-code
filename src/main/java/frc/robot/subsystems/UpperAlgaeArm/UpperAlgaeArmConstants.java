...
public class UpperAlgaeArmConstants {
    public static final class PhysicalProperties {
        private static final double kGearRatio = 1 / 30;
    }
    ...
    public static final class Encoder {
        public static final Angle kPositionConversion = Rotations.of(PhysicalProperties.kGearRatio);
    ...
    public static final class Feedforward {
        ...
        public static final Voltage kG = Volts.of(2.57);
        public static final Per<AngularVelocityUnit, VoltageUnit> kV = Rotations.per(Minute).per(Volt)
                .ofNative(473 * PhysicalProperties.kGearRatio);
    }
    ...
    public static final class Constraints {
        public static final AngularVelocity kVelocity = DegreesPerSecond.of(863.269);
